...
struct LoadingHeart: View {
    ...
    var body: some View {
        Image(systemName: "heart.fill")
            ...
            .animation(Animation.easeInOut(duration: timing).repeatForever(autoreverses: true), value: true)
            .rotationEffect(Angle(degrees: isAnimating ? 360 : 0))
            .animation(Animation.easeInOut(duration: timing * 2).repeatForever(autoreverses: false), value: true)
