    ...
    var body: some View {
        ZStack(alignment: .leading) {
            ...
            RoundedRectangle(cornerRadius: 25.0)
                ...
                .animation(Animation.linear(duration: timing).repeatForever(autoreverses: false), value: true)
            ...
            RoundedRectangle(cornerRadius: 25.0)
                ...
                .rotationEffect(Angle(degrees: -50))
                .offset(x: isAnimating ? frame.width : -frame.width)
                .animation(Animation.linear(duration: timing).repeatForever(autoreverses: false).delay(timing / 3), value: true)
            ...
            RoundedRectangle(cornerRadius: 25.0)
                ...
                .rotationEffect(Angle(degrees: -50))
                .offset(x: isAnimating ? frame.width : -frame.width)
                .animation(Animation.linear(duration: timing).repeatForever(autoreverses: false).delay(timing / 3 * 2), value: true)
